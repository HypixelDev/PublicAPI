...
public class LeaderboardsExample {
    public static void main(String[] args) {
        ...
        Request request = RequestBuilder.newBuilder(RequestType.LEADERBOARDS).createRequest();
        HypixelAPI.getInstance().getAsync(request, (Callback<LeaderboardsReply>) (failCause, result) -> {
            if (failCause != null) {
